...
const RULES = [
  ...
  { icon: Newspaper, name: 'News Trading', desc: 'Whether you are allowed to hold positions during high-impact news events. One Step and Two Step allow news trading. Instant Funding does not allow news trading.', detail: 'One Step & Two Step: Allowed · Instant: Not Allowed' },
